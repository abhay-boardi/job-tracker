import type { User, InsertUser, Job, InsertJob, ScrapeRun, InsertScrapeRun } from "./schema";
    ...
    const seedRuns: InsertScrapeRun[] = [
      {
        ...
        completedAt: new Date(Date.now() - 2 * 86400000 + 180000).toISOString(),
      },
      {
        source: "google_jobs",
      ...
      },
      {
        ...
        completedAt: new Date(Date.now() - 43200000 + 240000).toISOString(),
      },
      {
        source: "google_jobs",
        ...
        completedAt: new Date(Date.now() - 7200000 + 5000).toISOString(),
      },
      {
        source: "linkedin",
        ...
        completedAt: new Date(Date.now() - 3600000 + 200000).toISOString(),
      },
    ];
